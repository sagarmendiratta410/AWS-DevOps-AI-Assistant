...
### 2. AWS Account + Bedrock Model Access
...
### 3. IAM Role — DevOpsAIAssistantRole
...
### 4. OpenSearch Serverless — Vector Database
...
### 5. Confluence Loader — Company Wiki
...
### 7. GitHub Loader — Code Repository Docs
...
### 9. Chunking + Embeddings + Ingestion Pipeline
...
### 10. Vector Search (KNN) — Semantic Search
...
### 11. BM25 Keyword Search — Exact Match Search
...
### 12. Hybrid Search — Combined Vector + BM25
...
### 13. LLM Re-ranking — Nova Scores Each Chunk
...
### 14. RAG Chain — Retrieval + Nova Answer Generation
...
### 15. Agent State + LangGraph Graph
...
### 16. Agent Nodes — 6 Processing Steps
...
### 17. MCP Tools — CloudWatch, GitHub, Jira, Slack
...
### 18. DynamoDB Tables — Conversation + Incident Memory
...
### 19. Slack App + Socket Mode Connection
...
### 20. Slack Bot Handler — handler.py
...
### 21. End-to-End Testing — test_agent.py + test_slack.py
...
### 22. Output Quality Verification + Bug Fixes
...
1. Reads your company docs (Confluence, Jira, GitHub, S3 PDFs)
2. Stores them as smart vectors in OpenSearch
3. When an engineer asks a question in Slack, it searches docs using two methods (semantic + keyword)
4. Re-ranks results with AI
5. Retrieves relevant chunks and feeds them to Nova
6. Nova generates an answer citing sources
7. The agent can also run live tools (CloudWatch, Jira, GitHub) if needed
8. Remembers past conversations in DynamoDB
9. All accessible through a simple Slack interface
